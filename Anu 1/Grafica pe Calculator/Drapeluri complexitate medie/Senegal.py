...
import math as m
window=Tk()
window.title("Steagul Senegal Buza Catalin TI-214")
...
panza.create_rectangle(140,20,240,220,fill='yellow1',outline='black')
panza.create_rectangle(240,20,340,220,fill='red1',outline='black')
